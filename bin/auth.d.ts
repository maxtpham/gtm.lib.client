export declare module auth {
    ...
    function authenticate(userServiceUrl: string, initialUrlGetter: () => Promise<string>, dataGetter: (key: string) => Promise<string>, dataSetter: (key: string, value: string) => Promise<void>, dataRemover: (key: string) => Promise<void>): Promise<string>;
}
